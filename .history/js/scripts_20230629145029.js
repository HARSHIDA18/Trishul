...
fetch("data.csv")
  ...
  .then((csvData) => {
    ...
    var pressure1Index = headers.indexOf("Pressure1");
    var pressure2Index = headers.indexOf("Pressure2");
    var data = [];
...
fetch("data.csv")
  ...
  .then((csvData) => {
    ...
    var lines = csvData.split("\n");
    var headers = lines[0].split(",");
    var pressure1Index1 = headers.indexOf("Load");
    var pressure2Index2 = headers.indexOf("Time");
    var data = [];

    for (var i = 1; i < lines.length; i++) {
      var currentLine = lines[i].split(",");
      var pressure11 = parseFloat(currentLine[pressure1Index1]);
      var pressure21 = parseFloat(currentLine[pressure2Index2]);
      data.push([pressure11, pressure21]);
    }
